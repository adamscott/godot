...
#else
#define BROTLI_BSWAP16(V) ((uint16_t)((((V) & 0xFFU) << 8) | \
		(((V) >> 8) & 0xFFU)))
#endif
...
#else
#define BROTLI_BSWAP32(V) ((uint32_t)((((V) & 0xFFU) << 24) | (((V) & 0xFF00U) << 8) | \
...
#else
#define BROTLI_BSWAP64(V) ((uint64_t)((((V) & 0xFFU) << 56) | (((V) & 0xFF00U) << 40) | \
...
#define PREFETCH_L2(ptr) \
	do { \
		(void)(ptr); \
					...
					>>>>>>> b7839eb5f0([Web] Add compression / decompression capabilities)
#endif
