...
if os.name == "nt":
    defaults["use_mingw"] = {"default": False, "converter": BoolVariable("", "", False)[4]}
...
if os.name == "nt":
    base_opts.Add(BoolVariable("use_mingw", "Use the Mingw compiler, even if MSVC is installed.", False)),
...
if "import_env_vars" in env_base:
